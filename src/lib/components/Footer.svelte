<script lang="ts">
  ...
  const tourLinks = [
    { href: '/tours/9-day-cultural-circuit', label: 'Cultural Circuit' },
    { href: '/tours/11-day-round-tour', label: 'Round Tour' },
    { href: '/tours/9-day-wildlife-tour', label: 'Wildlife Tour' },
    { href: '/tours/5-day-honeymoon', label: 'Honeymoon Tour' }
  ];

  const socialLinks = [
    { href: 'https://instagram.com', label: 'Instagram', icon: 'instagram' },
    { href: 'https://facebook.com', label: 'Facebook', icon: 'facebook' },
    { href: 'https://wa.me/94777300852', label: 'WhatsApp', icon: 'whatsapp' }
  ];
</script>
...
<footer class="bg-gray-50 text-gray-900 text-xs">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        <h4 class="font-semibold text-lg mb-6">Our Tours</h4>
        <ul class="space-y-3">
